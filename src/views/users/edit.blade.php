@component('panel.layouts.component', ['title' => 'ویرایش کاربر'])
        ...
        <div class="row">
            <div class="col-md-12">
                @component('components.accordion')
                    @slot('cards')
                        @component('components.collapse-card', ['id' => 'user_edit', 'show' => 'show', 'title' => 'ویرایش کاربر'])
                            @slot('body')
                                <form method="POST"
                                            ...
                                            <div class="form-group has-primary">
                                                ...
                                                <select name="status" id="status"
                                                    ...
                                                    <option value="verified"
                                                        {{ old('status', $status) == 'verified' ? 'selected' : '' }}>تایید شده
                                                    </option>
                                                    <option value="not_verified"
                                                        {{ old('status', $status) == 'not_verified' ? 'selected' : '' }}>تایید نشده
                                                    </option>
                                                </select>
                                                @error('status')
                                                    <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="organization" type="text" class="form-control @error('organization') is-invalid @enderror"
                                                       name="organization" value="{{ $user->organization ?? old('organization') }}" autocomplete="off">
