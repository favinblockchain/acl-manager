@component('panel.layouts.component', ['title' => $model ? ( ($type == 'permission') ? 'دسترسی‌ها، ویرایش' : 'نقش‌ها، ویرایش') : ( ($type == 'permission') ? 'دسترسی‌ها، ایجاد' : 'نقش‌ها، ایجاد')])
        ...
        <div class="row">
            <div class="col-md-12">
                @component('components.accordion')
                    @slot('cards')
                        @component('components.collapse-card', ['id' => 'permission_role_edit', 'show' => 'show', 'title' => ''])
                            @slot('body')
                                <form method="POST"
